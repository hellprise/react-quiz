    ...
    state = {
        ...
        formControls: {
            ...
            password: {
                ...
                validation: {
                    required: true,
                    minLength: 6 // шесть символов потому, что Firebase (будет использоваться в этой проекте в качестве бекенда) требует минимальную длинну в размере 6-ти символов
                }
            }
        }
    }
        ...
        return Object.keys(this.state.formControls).map((controlName, index) => {
            ...
            return (
                <Input 
                    ...
                    label={control.label}
                    shouldValidate={!!control.validation} // с помощью !! приводим к булеан-типу control.validation
